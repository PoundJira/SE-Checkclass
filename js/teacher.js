    ...
    doc.docs
      .forEach(data => {
        if (data.data().namecourse != 'วิชา4') {
          $('#list-subject').append(createSubject(data.data().namecourse, data.data().nameteacher, data.data().room, data.data().time,data.data().passcourse,data.data().day)
          )
        }
      })
  })
...
function createSubject(namecourse, nameteacher, room, time,passcourse,day) {
  ...
  html += '<a href="blog1.html"><div class="information information_btn" name="post" value="1">เพิ่มนักศึกษาเข้าวิชา </div></a> '
  ...
  html += '</select></label>  <a href="blog2.html"><div class="information information_btn" name="post" value="2">ทำการเช็คชื่อ</div></a>'
  html += '<a href="blog3.html"><div class="information information_btn" name="post" value="3">ดูรายชื่อนักศึกษา</div></a>'
  html += '</div></div></div>'
